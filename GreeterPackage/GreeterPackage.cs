//------------------------------------------------------------------------------
// <copyright file="GreeterPackage.cs" company="Hewlett-Packard Company">
...
namespace GreeterPackage
{
    ...
    [Guid(GreeterPackage.PackageGuidString)]
    [SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1650:ElementDocumentationMustBeSpelledCorrectly", Justification = "pkgdef, VS and vsixmanifest are valid VS terms")]
    public sealed class GreeterPackage : Package
    {
        /// <summary>
        /// GreeterPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "1ddc306c-4535-4b23-b197-a682ef985f09";

        private readonly string _greeting;

        /// <summary>
        /// Initializes a new instance of the <see cref="GreeterPackage"/> class.
        /// </summary>
